                        ...
                        <div class="col-md-3 col-sm-6">  
                            <div class="widget widget_about">
                                ...
                                <div class="logo-footer clearfix p-b15">
                                    <a href="{{url('index.html')}}"><img src="{{asset('images/logo-7.png')}}" width="230" height="67" alt=""/></a>
                                </div>
                                    ...
                                    <div class="bdr-light-blue widget-post clearfix  bdr-b-1 m-b10 p-b10">
                                        ...
                                        <div class="wt-post-info">
                                            <div class="wt-post-header">
                                                <h6 class="post-title"><a href="{{url('blog-single.html')}}">Blog title first </a></h6>
                                            </div>
                        ...
                        <div class="col-md-3 col-sm-6">
                            <div class="widget widget_services">
                                ...
                                <ul>
                                    ...
                                    <li><a href="{{url('http://thewebmax.com/spa/services.html')}}">Services</a></li>
                    ...
                    <div class="row">
                        ...
                        <div class="wt-footer-bot-right">
                            <ul class="copyrights-nav pull-right"> 
                                <li><a href="{{url('javascript:void(0);')}}">Terms  & Condition</a></li>
                                <li><a href="{{url('javascript:void(0);')}}">Privacy Policy</a></li>
