...
@section('content') 
        ...
        <div class="page-content">
                    ...
                    <ul>    
                        ...
                        <li data-index="rs-2938" data-transition="slideleft" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="default"   data-thumb="{{asset('images/ufanisi/5ltr_collection.gif')}}"  data-rotate="0"  data-fsslotamount="7" data-saveperformance="off"  data-title="" data-param1="Additional Text" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                            ...
                            <div class="tp-caption tp-resizeme" 
                               ...
                               <a href="{{url('javascript:;')}}" class="site-button radius-sm button-lg">See all Services</a>
                               </div>
                            <!-- LAYER NR. 5 -->
                            ...
                            <div class="tp-caption tp-resizeme" 
                                ...
                                style="z-index:13; text-transform:uppercase; font-weight:700;">
                               <a href="{{url('javascript:;')}}" class="site-button-secondry radius-sm button-lg">More detail</a>
                               </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-7 col-sm-7">
                                <div class="about4-content">
                                    ...
                                    <h2><span class="text-primary">Welcome to </span> Spa Center </h2>
                                    ...
                                    <div>
                                        <a href="{{url('index-4.html#')}}" class="site-button radius-sm">
                                          <span class="font-weight-700 inline-block text-uppercase p-lr15">More</span> 
                                        </a>
                                        <a href="{{url('index-4.html#')}}" class="site-button-secondry radius-sm">
                    ...
                    <div class="tab-content">
                        ...
                        <div id="pricing-item4" class="pricing-tab-content-block tab-pane">
                            <div class="section-content p-t50">
                                    ...
                                    <div class="wt-tabs vertical bg-tabs">
                                        <ul class="nav nav-tabs">
                                            <li class="active"><a data-toggle="tab" href="{{url('index-4.html#pricing-tab4-1')}}">Hand-On Facial </a></li>
                                            <li><a data-toggle="tab" href="{{url('index-4.html#pricing-tab4-2')}}">Electrotherapy </a></li>
                                            <li><a data-toggle="tab" href="{{url('index-4.html#pricing-tab4-3')}}">Clean up</a></li>
                                            <li><a data-toggle="tab" href="{{url('index-4.html#pricing-tab4-4')}}">Anti Ageing </a></li>
                                            <li><a data-toggle="tab" href="{{url('index-4.html#pricing-tab4-5')}}">Glow & Radiance</a></li>
                                            <li><a data-toggle="tab" href="{{url('index-4.html#pricing-tab4-6')}}">Normal Wash</a></li>
                                        </ul>
                                        <div class="tab-content p-l50">
                        ...
                        <div id="pricing-item5" class="pricing-tab-content-block tab-pane">
                            <div class="section-content p-t50">
                                    ...
                                    <div class="wt-tabs vertical bg-tabs">
                                        <ul class="nav nav-tabs">
                                            <li class="active"><a data-toggle="tab" href="{{url('index-4.html#pricing-tab5-1')}}">Head</a></li>
                                            <li><a data-toggle="tab" href="{{url('index-4.html#pricing-tab5-2')}}">Back</a></li>
                                            <li><a data-toggle="tab" href="{{url('index-4.html#pricing-tab5-3')}}">Foot</a></li>
                                            <li><a data-toggle="tab" href="{{url('index-4.html#pricing-tab5-4')}}">Aromatherapy</a></li>
                                            <li><a data-toggle="tab" href="{{url('index-4.html#pricing-tab5-5')}}">Scrub</a></li>
                                            <li><a data-toggle="tab" href="{{url('index-4.html#pricing-tab5-6')}}">Tissue</a></li>
                                        </ul>
                                        <div class="tab-content p-l50">
                        ...
                        <div id="pricing-item6" class="pricing-tab-content-block tab-pane ">
                            <div class="section-content p-t50">
                                    ...
                                    <div class="wt-tabs vertical bg-tabs">
                                        <ul class="nav nav-tabs">
                                            <li class="active"><a data-toggle="tab" href="{{url('index-4.html#pricing-tab6-1')}}">Massage Therapy</a></li>
                                            <li><a data-toggle="tab" href="{{url('index-4.html#pricing-tab6-2')}}">Facials </a></li>
                                            <li><a data-toggle="tab" href="{{url('index-4.html#pricing-tab6-3')}}">Pedicures</a></li>
                                            <li><a data-toggle="tab" href="{{url('index-4.html#pricing-tab6-4')}}">Manicures</a></li>
                                            <li><a data-toggle="tab" href="{{url('index-4.html#pricing-tab6-5')}}">Body Wraps</a></li>
                                            <li><a data-toggle="tab" href="{{url('index-4.html#pricing-tab6-6')}}">Waxing & Cosmetics</a></li>
                                        </ul>
                                        <div class="tab-content p-l50">
                                            ...
                                            <div id="pricing-tab6-2" class="tab-pane">
                                                <div class="pricing-tab-inner">
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="wt-media">
                                                                <img src="{{url('images/our-services/large/s1.jpg')}}" alt="">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="wt-tilte">
                        ...
                        <div id="pricing-item7" class="pricing-tab-content-block tab-pane">
                            <div class="section-content p-t50">
                                    ...
                                    <div class="wt-tabs vertical bg-tabs">
                                        <ul class="nav nav-tabs">
                                            <li class="active"><a data-toggle="tab" href="{{url('index-4.html#pricing-tab7-1')}}">Hair Color</a></li>
                                            <li><a data-toggle="tab" href="{{url('index-4.html#pricing-tab7-2')}}">Braids & Twist</a></li>
                                            <li><a data-toggle="tab" href="{{url('index-4.html#pricing-tab7-3')}}">Corrective Color</a></li>
                                            <li><a data-toggle="tab" href="{{url('index-4.html#pricing-tab7-4')}}">Hair Extension</a></li>
                                            <li><a data-toggle="tab" href="{{url('index-4.html#pricing-tab7-5')}}">Hair Cut</a></li>
                                            <li><a data-toggle="tab" href="{{url('index-4.html#pricing-tab7-6')}}">Partial Foil</a></li>
                                        </ul>
                                        <div class="tab-content p-l50">
            ...
            <div class="section-full p-tb100 bg-bottom-center bg-full-width bg-no-repeat" style="background-image:url(images/background/bg-1.png);">
                <div class="container ">
                    <div class="section-head text-center">
                        <h2><span class="text-primary">Good for </span> your health </h2>
                        <div class="wt-separator-outer ">
                            <div class="wt-separator style-icon">
                                <i class="fa fa-leaf text-black"></i>
                                <span class="separator-left bg-primary"></span>
                    ...
                    <div class="section-content circle-block-outer" data-toggle="tab-hover">
                        <div class="row">
                            ...
                            <div class="col-md-4 col-sm-12 m-b30">
                                <div class="wt-icon-box-wraper right p-a10 m-b20" data-target="#tab1" data-toggle="tab">
                                    <div class="icon-md text-primary radius">
                                        <span class="icon-cell  text-primary"><img src="{{asset('images/icon/candle-1.png')}}" alt=""></span>
                                    </div>
                                    <div class="icon-content">
                                ...
                                <div class="wt-icon-box-wraper right p-a10 m-r30 m-b20" data-target="#tab2" data-toggle="tab">
                                    <div class="icon-md text-primary radius">
                                        <span class="icon-cell  text-primary"><img src="{{asset('images/icon/leaves.png')}}" alt=""></span>
                                    </div>
                                    <div class="icon-content">
                                ...
                                <div class="wt-icon-box-wraper right p-a10 m-b20" data-target="#tab3" data-toggle="tab">
                                    <div class="icon-md text-primary radius">
                                        <span class="icon-cell  text-primary"><img src="{{asset('images/icon/lotus-position.png')}}" alt=""></span>
                                    </div>
                                    <div class="icon-content">
                            ...
                            <div class="col-md-4 col-sm-12 m-b30">
                                <div class="circle-content-pic tab-content ">
                                    <div id="tab1" class="tab-pane active">
                                        <div class="wt-box">
                                            <div class="wt-media text-primary m-b20 ">
                                                <img src="{{asset('images/circle-block/1.jpg')}}" class="radius-bx" alt="">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div id="tab2" class="tab-pane">
                                        <div class="wt-box">
                                            <div class="wt-media text-primary m-b20">
                                                <img src="{{asset('images/circle-block/2.jpg')}}" class="radius-bx" alt="">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div id="tab3" class="tab-pane">
                                        <div class="wt-box">
                                            <div class="wt-media text-primary m-b20">
                                                <img src="{{asset('images/circle-block/3.jpg')}}" class="radius-bx" alt="">
                                            </div>
                                        </div>
                                    </div> 
                                    ...
                                    <div id="tab4" class="tab-pane">
                                        <div class="wt-box">
                                            <div class="wt-media text-primary m-b20">
                                                <img src="{{asset('images/circle-block/4.jpg')}}" class="radius-bx" alt="">
                                            </div>
                                        </div>
                                    </div> 
                                    ...
                                    <div id="tab5" class="tab-pane">
                                        <div class="wt-box">
                                            <div class="wt-media text-primary m-b20">
                                                <img src="{{asset('images/circle-block/5.jpg')}}" class="radius-bx" alt="">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div id="tab6" class="tab-pane">
                                        <div class="wt-box">
                                            <div class="wt-media text-primary m-b20">
                                                <img src="{{asset('images/circle-block/6.jpg')}}" class="radius-bx" alt="">
                                            </div>
                                        </div>
                                    </div> 
                            ...
                            <div class="col-md-4 col-sm-12 m-b30">
                                <div class="wt-icon-box-wraper left p-a10 m-b20" data-target="#tab4" data-toggle="tab">
                                    <div class="icon-md text-primary radius">
                                        <span class="icon-cell  text-primary"><img src="{{asset('images/icon/bathtub.png')}}" alt=""></span>
                                    </div>
                                    <div class="icon-content">
                                ...
                                <div class="wt-icon-box-wraper left p-a10 m-l30 m-b20" data-target="#tab5" data-toggle="tab">
                                    <div class="icon-md text-primary radius">
                                        <span class="icon-cell  text-primary"><img src="{{asset('images/icon/jacuzzi.png')}}" alt=""></span>
                                    </div>
                                    <div class="icon-content">
                                ...
                                <div class="wt-icon-box-wraper left p-a10 m-b20" data-target="#tab6" data-toggle="tab">
                                    <div class="icon-md text-primary radius">
                                        <span class="icon-cell  text-primary"><img src="{{asset('images/icon/massage.png')}}" alt=""></span>
                                    </div>
                                    <div class="icon-content">
            ...
            <div class="section-full bg-white p-tb80">
                <div class="container">
                    <!-- TITLE START-->
                    <div class="section-head text-center">
                        <h2><span class="text-primary">Our</span> Experts</h2>
                        <div class="wt-separator-outer ">
                            <div class="wt-separator style-icon">
                                <i class="fa fa-leaf text-black"></i>
                                <span class="separator-left bg-primary"></span>
                    ...
                    <div class="section-content wt-our-team">
                        <div class="row">
                            ...
                            <div class="col-md-4 col-sm-4 p-tb15">
                                <div class="wt-team-one bg-white">
                                    <div class="wt-team-media">
                                        <a href="{{url('javascript:void(0);')}}"><img src="{{asset('images/our-team4/ex1.jpg')}}" class="" alt=""></a>
                                    </div>
                                    <div class="wt-team-info text-center bg-white p-a10">
                                        <h4 class="wt-team-title"><a href="{{url('javascript:void(0);')}}">Camila</a></h4>
                                        <p>Founder, Beauty Spa</p>
                                        <ul class="social-icons social-square social-dark">
                                            <li><a href="{{url('javascript:void(0);')}}" class="fa fa-facebook"></a></li>
                                            <li><a href="{{url('javascript:void(0);')}}" class="fa fa-twitter"></a></li>
                                            <li><a href="{{url('javascript:void(0);')}}" class="fa fa-linkedin"></a></li>
                                            <li><a href="{{url('javascript:void(0);')}}" class="fa fa-rss"></a></li>
                                            <li><a href="{{url('javascript:void(0);')}}" class="fa fa-youtube"></a></li>
                                            <li><a href="{{url('javascript:void(0);')}}" class="fa fa-instagram"></a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4 col-sm-4 p-tb15">
                                <div class="wt-team-one bg-white">
                                    <div class="wt-team-media">
                                        <a href="{{url('javascript:void(0);')}}"><img src="{{asset('images/our-team4/ex2.jpg')}}" class="" alt=""></a>
                                    </div>
                                    <div class="wt-team-info text-center bg-white p-a10">
                                        <h4 class="wt-team-title"><a href="{{url('javascript:void(0);')}}">Milagros</a></h4>
                                        <p>Founder, Beauty Spa</p>
                                        <ul class="social-icons social-square social-dark">
                                            <li><a href="{{url('javascript:void(0);')}}" class="fa fa-facebook"></a></li>
                                            <li><a href="{{url('javascript:void(0);')}}" class="fa fa-twitter"></a></li>
                            ...
                            <div class="col-md-4 col-sm-4 p-tb15">
                                <div class="wt-team-one bg-white">
                                    <div class="wt-team-media">
                                        <a href="{{url('javascript:void(0);')}}"><img src="{{asset('images/our-team4/ex3.jpg')}}" class="" alt=""></a>
                                    </div>
                                    <div class="wt-team-info text-center bg-white p-a10">
                                        <h4 class="wt-team-title"><a href="{{url('javascript:void(0);')}}">Agustina.</a></h4>
                                        <p>Founder, Beauty Spa</p>
                                        <ul class="social-icons social-square social-dark">
                                            <li><a href="{{url('javascript:void(0);')}}" class="fa fa-facebook"></a></li>
                                            <li><a href="{{url('javascript:void(0);')}}" class="fa fa-twitter"></a></li>
            ...
            <div class="section-full  special-offer-block2 overlay-wraper bg-repeat p-t80 p-b50"  style="background-image:url(images/background/bg-6.jpg);">
                <div class="overlay-main bg-white opacity-01"></div>
                <div class="left-larg-pic">
                    <div class="wt-media">
                        <img src="{{asset('images/stone_flower2.png')}}" alt="">
                    </div>
                </div>
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-9 col-sm-9">
                            <div class="awesome-counter text-right">
                                ...
                                <h2 class="font-60 font-weight-600"><span class="text-primary">Our Special Offer </span></h2>
                            ...
                            <div class="pull-right counter-small">
                ...
                <div class="container">
                    ...
                    <div class="filter-wrap p-a15 our-gallery  m-tb30">
                        <ul class="masonry-filter link-style  text-uppercase center-block m-t0">
                            <li class="active"><a data-filter="*" href="{{url('index-4.html#')}}">All</a></li>
                            <li><a data-filter=".cat-filter-1" href="{{url('index-4.html#')}}">Hair cut</a></li>
                            <li><a data-filter=".cat-filter-2" href="{{url('index-4.html#')}}">Foot</a></li>
                            <li><a data-filter=".cat-filter-3" href="{{url('index-4.html#')}}">Body</a></li>
                            <li><a data-filter=".cat-filter-4" href="{{url('index-4.html#')}}">Massage</a></li>
                            <li><a data-filter=".cat-filter-5" href="{{url('index-4.html#')}}">Face massage</a></li>
                        </ul>
                    </div>
                    <!-- PAGINATION END -->
                                    ...
                                    <div class="wt-gallery-bx">
                                        <div class="wt-thum-bx wt-img-effect wt-img-overlay7">
                                            ...
                                            <a href="{{url('javascript:void(0);')}}">
                                                <img src="{{asset('images/gallery/portrait/pic5.jpg')}}"  alt="">
                                            </a>
                                            ...
                                            <div class="overlay-bx">
                                                <div class="overlay-icon">
                                                    ...
                                                    <a href="{{asset('images/gallery/portrait/pic5.jpg')}}" class="mfp-link">
                                ...
                                <div class="masonry-item cat-filter-2 col-lg-4 col-md-4 col-sm-6 col-xs-6">
                                    <div class="wt-gallery-bx">
                                        <div class="wt-thum-bx wt-img-effect wt-img-overlay7">
                                            ...
                                            <a href="{{url('javascript:void(0);')}}">
                                                <img src="{{asset('images/gallery/portrait-half/pic1.jpg')}}"  alt="">
                                            </a>
                                            ...
                                            <div class="overlay-bx">
                                                <div class="overlay-icon">
                                                    ...
                                                    <a href="{{asset('images/gallery/portrait-half/pic1.jpg')}}" class="mfp-link">
                                                        <i class="fa fa-picture-o wt-icon-box-xs"></i>
                                                    </a>
                                                </div>
                                            </div>
                                ...
                                <div class="masonry-item cat-filter-3 col-lg-4 col-md-4 col-sm-6 col-xs-6">
                                    <div class="wt-gallery-bx">
                                        <div class="wt-thum-bx wt-img-effect wt-img-overlay7">
                                            ...
                                            <a href="{{url('javascript:void(0);')}}">
                                                <img src="{{asset('images/gallery/portrait/pic6.jpg')}}"  alt="">
                                            </a>
                                            ...
                                            <div class="overlay-bx">
                                                <div class="overlay-icon">
                                                    ...
                                                    <a href="{{asset('images/gallery/portrait/pic6.jpg')}}" class="mfp-link">
                                                        <i class="fa fa-picture-o wt-icon-box-xs"></i>
                                                    </a>
                                                </div>
                                            </div>
                                ...
                                <div class="masonry-item cat-filter-4 col-lg-4 col-md-4 col-sm-6 col-xs-6">
                                    <div class="wt-gallery-bx">
                                        <div class="wt-thum-bx wt-img-effect wt-img-overlay7">
                                            ...
                                            <a href="{{url('javascript:void(0);')}}">
                                                <img src="{{asset('images/gallery/portrait-half/pic2.jpg')}}"  alt="">
                                            </a>
                                            ...
                                            <div class="overlay-bx">
                                                <div class="overlay-icon">
                                                    ...
                                                    <a href="{{asset('images/gallery/portrait-half/pic2.jpg')}}" class="mfp-link">
                                                        <i class="fa fa-picture-o wt-icon-box-xs"></i>
                                                    </a>
                                                </div>
                                            </div>
                                ...
                                <div class="masonry-item cat-filter-5 col-lg-4 col-md-4 col-sm-6 col-xs-6">
                                    <div class="wt-gallery-bx">
                                        <div class="wt-thum-bx wt-img-effect wt-img-overlay7">
                                            ...
                                            <a href="{{url('javascript:void(0);')}}">
                                                <img src="{{asset('images/gallery/portrait-half/pic3.jpg')}}"  alt="">
                                            </a>
                                            ...
                                            <div class="overlay-bx">
                                                <div class="overlay-icon">
                                                    ...
                                                    <a href="{{asset('images/gallery/portrait-half/pic3.jpg')}}" class="mfp-link">
                                                        <i class="fa fa-picture-o wt-icon-box-xs"></i>
                                                    </a>
                                                </div>
                                            </div>
                                ...
                                <div class="masonry-item cat-filter-1 col-lg-8 col-md-8 col-sm-8 col-xs-6">
                                    <div class="wt-gallery-bx">
                                        <div class="wt-thum-bx wt-img-effect wt-img-overlay7">
                                            ...
                                            <a href="{{url('javascript:void(0);')}}">
                                                <img src="{{asset('images/gallery/landscape-half/pic1.jpg')}}"  alt="">
                                            </a>
                                            ...
                                            <div class="overlay-bx">
                                                <div class="overlay-icon">
                                                    ...
                                                    <a href="{{asset('images/gallery/landscape-half/pic1.jpg')}}" class="mfp-link">
                                                        <i class="fa fa-picture-o wt-icon-box-xs"></i>
                                                    </a>
                                                </div>
                                            </div>
            ...
            <div class="section-full  overlay-wraper bg-white bg-parallax  p-tb80" data-stellar-background-ratio="0.5" style="background-image:url(images/background/bg-12.jpg);">
                    <div class="overlay-main bg-white opacity-07"></div>
                    <div class="container">
                    
                        <!-- TITLE START-->
                        <div class="section-head text-center">
                            <h2><span class="text-primary">Our</span> Pricing</h2>
                            <div class="wt-separator-outer ">
                                <div class="wt-separator style-icon">
                                    <i class="fa fa-leaf text-black"></i>
                                    <span class="separator-left bg-primary"></span>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 m-b40">
                                        <div class="pricingtable-wrapper overlay-wraper  pricing-table-style-3" >
                                            <div class="pricingtable-inner bg-no-repeat bg-cover" style="background-image:url(images/gallery/portrait/pic1.jpg);">
                                                ...
                                                <div class="pricingtable-footer">
                                                    <a href="{{url('javascript:void(0);')}}" class="site-button white text-uppercase radius-sm">Purchase</a>
                                                </div>
                                    ...
                                    <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 m-b40">
                                        <div class="pricingtable-wrapper overlay-wraper  pricing-table-style-3" >
                                            <div class="pricingtable-inner bg-no-repeat bg-cover" style="background-image:url(images/gallery/portrait/pic2.jpg);">
                                    ...
                                    <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 m-b40">
                                        <div class="pricingtable-wrapper overlay-wraper  pricing-table-style-3" >
                                            <div class="pricingtable-inner bg-no-repeat bg-cover" style="background-image:url(images/gallery/portrait/pic3.jpg);">
            ...
            <div class="section-full bg-white p-tb80 bg-bottom-right bg-no-repeat" style="background-image:url(images/stone-spa.png)">
                <div class="container">
                    <!-- TITLE START-->
                    <div class="section-head text-center">
                        <h2><span class="text-primary">Our</span> Products</h2>
                    ...
                    <div class="section-content">
                        <div class="row">
                            ...
                            <!-- COLUMNS 1 -->
                            <div class="col-md-3 col-sm-6 p-tb15">
                                <div class="wt-box bg-white wt-product-box">
                                    <div class="wt-media text-primary">
                                        <img src="{{asset('images/products/pic-8.jpg')}}"  alt="">
                                    </div>
                                    <div class="wt-info p-a20 text-center">
                                        ...
                                        <div class="p-t10">
                                            <a class="site-button text-uppercase radius-sm font-weight-700 button-md">Add to cart</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-3 col-sm-6 p-tb15">
                                <div class="wt-box bg-white wt-product-box">
                                    <div class="wt-media text-primary">
                                        <img src="{{asset('images/products/pic-2.jpg')}}"  alt="">
                                    </div>
                                    <div class="wt-info p-a20 text-center">
                                        <h3>Flower</h3>
                                        <span class="price">
                            ...
                            <div class="col-md-3 col-sm-6 p-tb15">
                                <div class="wt-box bg-white wt-product-box">
                                    <div class="wt-media text-primary">
                                        <img src="{{asset('images/products/pic-9.jpg')}}"  alt="">
                                    </div>
                                    <div class="wt-info p-a20 text-center">
                                        <h3>Massage Oil.</h3>
                                        <span class="price">
                            ...
                            <div class="col-md-3 col-sm-6 p-tb15">
                                <div class="wt-box bg-white wt-product-box">
                                    <div class="wt-media text-primary ">
                                        <img src="{{asset('images/products/pic-5.jpg')}}"  alt="">
                                    </div>
                                    <div class="wt-info p-a20 text-center">
                                        <h3>Finnish sauna</h3>
                                        <span class="price">
                            ...
                            <div class="col-md-7 col-sm-7 contact-home4-right p-t130 p-b50" >
                                <div class="section-content">
                                    <div class="opening-block bdr-5 bdr-primary p-a40 text-right">
                                        <a href="{{url('services-2.html')}}" class="bg-primary book-now-btn p-tb5 p-lr15 text-uppercase font-16 font-weight-500">All Services</a>
                            ...
                            <div class="col-md-6 col-sm-12">
                                ...
                                <div class="blog-post latest-blog-3 blog-md date-style-1 clearfix">
                                    <div class="wt-post-media wt-img-effect zoom-slow">
                                        <a href="{{url('javascript:void(0);')}}"><img src="{{asset('images/blog/blog-small/pic1.jpg')}}" alt=""></a>
                                    </div>
                                    <div class="wt-post-info">
                                        <div class="wt-post-title ">
                                            <h4 class="post-title font-weight-800"><a href="{{url('javascript:void(0);')}}">Oil Massage</a></h4>
                                        </div>
                                        <div class="wt-post-meta ">
                                            <ul>
                                                <li class="post-date"> <i class="fa fa-calendar"></i><strong>18 Jan</strong> <span> 2018</span> </li>
                                                <li class="post-author"><i class="fa fa-user"></i><a href="{{url('javascript:void(0);')}}">By <span>John</span></a> </li>
                                                <li class="post-comment"><i class="fa fa-comments"></i> <a href="{{url('javascript:void(0);')}}">0</a> </li>
                                            </ul>
                                        </div>
                                ...
                                <div class="blog-post latest-blog-3 blog-md date-style-1 clearfix">
                                    <div class="wt-post-media wt-img-effect zoom-slow">
                                        <a href="{{url('javascript:void(0);')}}"><img src="{{asset('images/blog/blog-small/pic2.jpg')}}" alt=""></a>
                                    </div>
                                    <div class="wt-post-info">
                                        <div class="wt-post-title ">
                                            <h4 class="post-title font-weight-800"><a href="{{url('javascript:void(0);')}}">Beauty Treatment</a></h4>
                                        </div>
                                        <div class="wt-post-meta ">
                                            <ul>
                                ...
                                <div class="blog-post latest-blog-3 blog-md date-style-1 clearfix">
                                    <div class="wt-post-media wt-img-effect zoom-slow">
                                        <a href="{{url('javascript:void(0);')}}"><img src="{{asset('images/blog/blog-small/pic3.jpg')}}" alt=""></a>
                                    </div>
                                    <div class="wt-post-info">
                                        <div class="wt-post-title ">
                                            <h4 class="post-title font-weight-800"><a href="{{url('javascript:void(0);')}}">Fairness treatment</a></h4>
                                        </div>
                                        <div class="wt-post-meta ">
                                            <ul>
                                ...
                                <div class="blog-post latest-blog-3 overlay-wraper post-overlay date-style-1 bg-cover bg-no-repeat bg-top-center"  style="background-image:url(images/blog-big.jpg);">
                                    ...
                                    <div class="wt-post-info p-a30 p-b20 text-white">
                                        <div class="post-overlay-position">
                                            <div class="wt-post-title ">
                                                <h3 class="post-title"><a href="{{url('javascript:;')}}" class="text-white text-capitalize">Relaxation. No longer beyond your budget. </a></h3>
                                            </div>
                                            <div class="wt-post-meta ">
                                                <ul>
                                                    <li class="post-date"><i class="fa fa-calendar"></i><strong>6 Jan</strong> <span> 2018</span></li>
                                                    <li class="post-author"><i class="fa fa-user"></i>By <a href="{{url('javascript:;')}}">Admin</a> </li>
                                                    <li class="post-comment"><i class="fa fa-comments"></i> <a href="{{url('javascript:;')}}">2 comment</a> </li>
                                                </ul>
                                            </div>
                                            <div class="wt-post-text">
            ...
            <div class="section-full p-t50 p-b10 overlay-wraper bg-primary bg-repeat" style="background-image:url(images/background/bg-7.png);">
                <div class="container">
                    ...
                    <div class="section-content">
                        <div class="owl-carousel client-logo-carousel">
                            ...
                            <div class="item">
                                <div class="ow-client-logo">
                                    <div class="client-logo wt-img-effect on-color">
                                        <a href="{{url('javascript:;')}}"><img src="{{asset('images/client-logo/logo1.png')}}" alt=""></a>
                                    </div>
                                </div>
                            </div>
                            <!-- COLUMNS 2 --> 
                            <div class="item">
                                <div class="ow-client-logo">
                                    <div class="client-logo wt-img-effect on-color">
                                        <a href="{{url('javascript:;')}}"><img src="{{asset('images/client-logo/logo2.png')}}" alt=""></a>
                                    </div>
                                </div>
                            </div>
                            <!-- COLUMNS 3 --> 
                            <div class="item">
                                <div class="ow-client-logo">
                                    <div class="client-logo wt-img-effect on-color">
                                        <a href="{{url('javascript:;')}}"><img src="{{asset('images/client-logo/logo3.png')}}" alt=""></a>
                                    </div>
                                </div>
                            </div>
                            <!-- COLUMNS 4 --> 
                            <div class="item">
                                <div class="ow-client-logo">
                                    <div class="client-logo wt-img-effect on-color">
                                        <a href="{{url('javascript:;')}}"><img src="{{asset('images/client-logo/logo4.png')}}" alt=""></a>
                                    </div>
                                </div>
                            </div>
                            <!-- COLUMNS 5 --> 
                            <div class="item">
                                <div class="ow-client-logo">
                                    <div class="client-logo wt-img-effect on-color">
                                        <a href="{{url('javascript:;')}}"><img src="{{asset('images/client-logo/logo5.png')}}" alt=""></a>
                                    </div>
                                </div>
                            </div>
                            <!-- COLUMNS 6 --> 
                            <div class="item">
                                <div class="ow-client-logo">
                                    <div class="client-logo wt-img-effect on-color">
                                        <a href="{{url('javascript:;')}}"><img src="{{asset('images/client-logo/logo6.png')}}" alt=""></a>
                                    </div>
                                </div>
                            </div>
                            <!-- COLUMNS 7 --> 
                            <div class="item">
                                <div class="ow-client-logo">
                                    <div class="client-logo wt-img-effect on-color">
                                        <a href="{{url('javascript:;')}}"><img src="{{asset('images/client-logo/logo7.png')}}" alt=""></a>
                                    </div>
                                </div>
                            </div>
                            <!-- COLUMNS 8 --> 
                            <div class="item">
                                <div class="ow-client-logo">
                                    <div class="client-logo wt-img-effect on-color">
                                        <a href="{{url('javascript:;')}}"><img src="{{asset('images/client-logo/logo8.png')}}" alt=""></a>
                                    </div>
                                </div>
                            </div>
                            <!-- COLUMNS 9 --> 
                            <div class="item">
                                <div class="ow-client-logo">
                                    <div class="client-logo wt-img-effect on-color">
                                        <a href="{{url('javascript:;')}}"><img src="{{asset('images/client-logo/logo9.png')}}" alt=""></a>
                                    </div>
                                </div>
                            </div>
                            <!-- COLUMNS 10 --> 
                            <div class="item">
                                <div class="ow-client-logo">
                                    <div class="client-logo wt-img-effect on-color">
                                        <a href="{{url('javascript:;')}}"><img src="{{asset('images/client-logo/logo10.png')}}" alt=""></a>
                                    </div>
                                </div>
                            </div>
                            <!-- COLUMNS 11 --> 
                            <div class="item">
                                <div class="ow-client-logo">
                                    <div class="client-logo wt-img-effect on-color">
                                        <a href="{{url('javascript:;')}}"><img src="{{asset('images/client-logo/logo11.png')}}" alt=""></a>
                                    </div>
                                </div>
                            </div>
                            <!-- COLUMNS 12 --> 
                            <div class="item">
                                <div class="ow-client-logo">
                                    <div class="client-logo wt-img-effect on-color">
                                        <a href="{{url('javascript:;')}}"><img src="{{asset('images/client-logo/logo12.png')}}" alt=""></a>
                                    </div>
                                </div>
                            </div>                        
